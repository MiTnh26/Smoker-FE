...
const SongCard = ({ title, artistName, songSrc, userId, songId, file }) => {
  ...
  const currentUserId = "test-user-id"; // Thay bằng userId mong muốn
  ...
  // Nếu muốn thêm vào playlist hoặc queue, hãy xử lý ở component cha hoặc bổ sung context phù hợp
  const handleAddToPlaylist = () => {
    // TODO: Thêm logic thêm vào playlist nếu cần
    navigate("/playlists");
  };

  const handlePlayNext = () => {
    // TODO: Thêm logic play next nếu cần
  };
