...
import DJRegisterStep1 from "../components/DJRegisterStep1";
import DJTermsModal from "../components/DJTermsModal";
    ...
    <div className="min-h-screen bg-[#F0F2F5] py-8">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-foreground mb-2">Đăng ký DJ</h2>
          <p className="text-sm text-muted-foreground">Hoàn thành các bước sau để tạo trang DJ của bạn</p>
        </div>
