// src/modules/business/pages/DJRegister.js
...
export default function DJRegister() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("DJ registration data:", formData);
    // TODO: call API đăng ký DJ tại đây
    navigate("/customer/newsfeed");
  };

  return (
    <div className="max-w-lg mx-auto mt-10 bg-white p-6 rounded-2xl shadow">
      <h2 className="text-2xl font-bold mb-6 text-center">Đăng ký DJ</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block font-medium mb-1">Thể loại âm nhạc</label>
          <input
            type="text"
            name="genre"
